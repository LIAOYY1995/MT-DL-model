...
* Modal.txt: Contains modal shape data of the structure (The vortex induced vibration of a flexible riser)
* Pipe_Displacement_result.txt: Contains vibration response data of the vortex induced vibration of a flexible riser 
